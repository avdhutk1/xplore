 ...
 */
package com.audhut.odl.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import com.audhut.odl.cli.api.ExamplesCliCommands;
...
public class ExamplesCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ExamplesCliTestCommand.class);
    protected final ExamplesCliCommands service;

    public ExamplesCliTestCommand(final ExamplesCliCommands service) {
