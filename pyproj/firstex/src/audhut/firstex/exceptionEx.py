...
'''
You can have multiple exceptions caught in the except clause
empyt except clause means that all exceptions are caught
'''
try:
    #grail()
    
    #pass  #uncomment this to see teh else cluase in action
except AlreadyGotOneException, IndexError:
    print('got user defined exception ')
else:
    print('else clause - no user exception')    
